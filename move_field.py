...
class Wheel:
    ...
    #       both of course.)
    def __init__(self, tpm, car = None):
        self.car = car
        self.tpm = tpm  # Tire Pressure Monitoring System.
...
# TODO: Rewrite the following after moving tpms to the 'Wheel' class.
wheels = [Wheel(tpms_di['front-right'], None), Wheel(tpms_di['front-left'], None), 
          Wheel(tpms_di['back-right'],None), Wheel(tpms_di['back-left'], None)]
